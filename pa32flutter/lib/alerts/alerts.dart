                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          "${myAlertsData[index].alarmTime.substring(5, 16)}",
                                        ),
                                        SizedBox(
                                          width: 10,
                                        ),
                                        Text(
                                          "${myAlertsData[index].alarmTypeName}",
                                        ),
                                      ],
                                    ),
